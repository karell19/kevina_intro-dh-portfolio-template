...
```python
# pd.DataFrame(paragraph_list).rename(columns={0:'text'})[:-1]
...
```
    ...
    [K     |████████████████████████████████| 12.8 MB 15.0 MB/s eta 0:00:01
...
# ISSUE: Too many columns. How do I get rid of them? What is causing this error?
...
grant_memoir = pd.read_csv('grant_paragraphs.csv').reset_index().rename(columns={'index':'Paragraph',0:'Text'})
grant_memoir
```
...
```
    ...
    Pacific	LOC
    March	DATE
    the end of the July	DATE
    Pacific	LOC
    Congress	ORG
    the winter of 1863-4	DATE
    West	LOC
...
### Note: I am able to access all entities that are either GPE or LOC type. Issue must lie in production of place_freq.


```python
for i in range(len(grant_memoir)):
    of_interest = grant_memoir['Text'][i]
    doc = nlp(of_interest) 
    place_freq = collections.defaultdict(int)
...
# ISSUE: Table should have way more locations and frequency values. Do not understand where this issue lies?
...
```
    ...
    {'Nashville': 1, 'Cairo': 4, 'Columbus': 1}
...
### Note: Also able to print each text as included in the dictionary...


```python
print(grant_memoir['Text'])
print(grant_memoir['Text'][0])
```

    0      My family, all this while, was at the East. It...
    1      In the late summer of 1854 I rejoined my famil...
    2      In the winter I established a partnership with...
    3      While a citizen of Missouri, my first opportun...
    4      I have no apologies to make for having been on...
                                 ...                        
    603    During this visit I reviewed Banks' army a sho...
    604    While I was absent General Sherman declined to...
    605    On the 13th of September, while I was still in...
    606    Before the receipt by me of these orders the b...
    607    It seems that Halleck suggested that I should ...
